  ...
  <div class="bg-gray-900 w-screen h-screen flex items-center justify-center">
    <div class="p-4 bg-gray-800 text-white rounded-[50px] flex justify-center border
      ...
      <div class="flex justify-center items-center">
        <h4 class="m-5 w-20 text-right text-lg">Mail</h4>
      ...
      <button @click="SignIn" class="mt-20 mx-30 mb-5 bg-[#7ed2ea] text-[#003641] h-10 rounded-[50px] 
                     cursor-pointer hover:animate-pulse">Sign in</button>
